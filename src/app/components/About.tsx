        ...
        <div className="lg:flex justify-between items-center">
          <div className="lg:w-6/12 lg:p-0 p-7">
            ...
            <p className="text-xl text-zinc-200 bg-[#0e2f4b]">
              is a highly experienced Senior Software Engineer with a focus on
              Front End Technologies. With over 10 years of experience
              delivering enterprise applications for leading organizations
              across different regions. He is a strategic thinker and a team
              player, providing technical roadmaps and promoting a diverse and
              inclusive work environment that encourages innovation and
              creativity.
            </p>
            ...
            <div className="py-5 flex gap-x-4">
              <a
                title="Linkedin"
                href="https://www.linkedin.com/in/razazaidisd/"
                target="_blank"
              ...
              <a
                title="Github"
                href="https://github.com/razazaidisd"
                target="_blank"
                className="text-slate-50 hover:text-white dark:hover:text-white"
              >
                <svg
              ...
              <a
                href="https://www.facebook.com/zaidisd/"
                title="Facebook"
                target="_blank"
                className="text-slate-50 hover:text-white dark:hover:text-white"
              >
              ...
              <a
                title="Instagram"
                href="https://www.instagram.com/razazaidisd/"
                target="_blank"
                className="text-slate-50 hover:text-white dark:hover:text-white"
              >
                <svg
          ...
          <div className="lg:w-4/12 rounded-full scale-100 rounded-lg ">
            <Image
              className="hero-img"
              width="300"
              height="250"
